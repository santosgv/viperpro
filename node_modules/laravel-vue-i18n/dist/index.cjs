...
const pluralization_1 = require("./pluralization.cjs");
const avoid_exceptions_1 = require("./utils/avoid-exceptions.cjs");
const has_php_translations_1 = require("./utils/has-php-translations.cjs");
